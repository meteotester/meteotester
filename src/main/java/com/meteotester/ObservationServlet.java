...
public class ObservationServlet extends HttpServlet {
	...
	private static Logger log = Logger.getLogger(ObservationServlet.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((sourceId == null) || (sourceId.equals(""))) {
			...
			HashMap<String, Source> sources = sourcesHelper.getObservationSources();
			...
			Source source = sourcesHelper.getObservationSourceById(sourceId);
			result += Parser.parse2store(source, place);
		}
