...
03 12 * * * wget 'http://www.meteotester.com/observations?place=Atlantic%20City' >> meteotester_cron.log 2>&1
04 12 * * * wget 'http://www.meteotester.com/forecasts?place=Atlantic%20City' >> meteotester_cron.log 2>&1
